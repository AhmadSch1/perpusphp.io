...
<html lang="en">
  ...
  <select class="form-select" id="inputGroupSelect01" name="jurusan">
    <option selected>Choose</option>
    <option value="Desain Gambar Mesin">Rekayasa Perangkat Lunak</option>
    <option value="Teknik Otomotif">Teknik Otomotif</option>
    <option value="Desain Pemodelan Informasi Bangunan"> Tata Busana</option>
    <option value="Teknik Konstruksi Perumahan">tataboga</option>
    <option value="Teknik Tenaga Listrik">pariwisata</option>
    <option value="Teknik Instalasi Tenaga Listrik">perhotelan</option>
    <option value="Teknik Komputer Jaringan">Teknik Komputer Jaringan</option>
    <option value="Sistem Informatika Jaringan dan Aplikasi">pemasaran</option>
    <option value="Rekayasa Perangkat Lunak">Akutansi Keuagan Lembaga</option>
